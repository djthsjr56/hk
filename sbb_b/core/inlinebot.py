...
CATLOGO = "https://iyaddz.ml/images/Davis.jpg"
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**sbb_b"):
            buttons = [
                (
                    ...
                    Button.url("DEV", "https://t.me/w8oww"),
                )
            ]
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/gjk_e"),
                Button.url(
                    "المطور",
                    "t.me/w8oww",
                ),
        ...
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="[𝙏𝙀𝙋𝙏𝙃𝙊𝙉 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/gjk_e)",
